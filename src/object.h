...
class Example : public Napi::ObjectWrap<Example> {
    ...
    private:
        ...
        static std::vector<Engine::Region> RegionsJsToCpp(const uint_fast32_t pixLen, const uint_fast8_t regionsLen, const Napi::Array &regionsJs);
