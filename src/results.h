...
namespace Results {
    ...
    Napi::Array ToJs(const Napi::Env &env, const uint_fast8_t regionsLen, const std::vector<Engine::Region2> &regionsVec, const std::vector<uint_fast32_t> &percentResultVec);
