...
Napi::Array Results::ToJs(const Napi::Env &env, const std::string &name, const uint_fast32_t diffsPerc,
...
Napi::Array Results::ToJs(const Napi::Env &env, const uint_fast32_t regionsLen,
                          const std::vector<Engine::Region> &regionVec,
...
Napi::Array Results::ToJs(const Napi::Env &env, const std::string &name, const uint_fast32_t diffsPerc,
                          const Engine::BoundsResult boundsResult) {
    Napi::Array resultsJs = Napi::Array::New(env);
...
Napi::Array Results::ToJs(const Napi::Env &env, const uint_fast32_t regionsLen,
                          const std::vector<Engine::Region> &regionVec,
                          const std::vector<Engine::BoundsResult> &boundsResultVec) {
    Napi::Array resultsJs = Napi::Array::New(env);
