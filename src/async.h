...
class RgbAllPercent : public GrayAllPercent {
    public:
...
class GrayMaskPercent : public GrayAllPercent {
    public:
...
class RgbMaskPercent : public GrayMaskPercent {
    public:
...
class RgbRegionsPercent : public GrayRegionsPercent {
    public:
...
class GrayAllBounds : public Napi::AsyncWorker {
    public:
        GrayAllBounds(const std::string target, const uint_fast16_t width, const uint_fast16_t height, const uint_fast32_t pixCount, const uint_fast8_t pixDiff, const uint_fast8_t diffsPerc, const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb);
        void Execute();
        void OnOK();
    protected:
        const std::string target_;
...
class GrayMaskBounds : public GrayAllBounds {
    public:
        GrayMaskBounds(const std::string target, const uint_fast16_t width, const uint_fast16_t height, const uint_fast32_t pixCount, const uint_fast8_t pixDiff, const uint_fast8_t diffsPerc, const uint_fast32_t bitsetCount, const std::vector<bool> &bitsetVec, const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb);
        void Execute();
    private:
        const uint_fast32_t bitsetCount_;
        const std::vector<bool> &bitsetVec_;
