...
Example::Example(const Napi::CallbackInfo &info) : Napi::ObjectWrap<Example>(info) {
    ...
    if (obj.Has("regions")) {
        ...
        this->regionVec_ = this->RegionsJsToCpp(this->pixCount_, this->regionsLen_, regionsJs);
    }
...
std::vector<Engine::Region> Example::RegionsJsToCpp(const uint_fast32_t pixLen, const uint_fast8_t regionsLen, const Napi::Array &regionsJs) {
...
Napi::Value Example::GrayRegionsPercentSync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    ...
    Napi::Array resultsJs = Results::ToJs(env, this->regionsLen_, this->regionVec_, resultsVec);
    cb.Call({env.Null(), resultsJs});
    return env.Undefined();
}
...
Napi::Value Example::GrayRegionsPercentAsync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    GrayRegionsPercent *grayRegionsPercent = new GrayRegionsPercent(this->pixCount_, this->minDiff_, this->regionsLen_, this->regionVec_, buf0, buf1, cb);
...
Napi::Value Example::RgbAllPercentSync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    uint_fast8_t percentResult = Engine::RgbAllPercent(this->pixCount_, this-> pixDepth_, this->bufLen_, this->pixDiff_, buf0, buf1);
    Napi::Array resultsJs = Results::ToJs(env, this->target_, this->diffsPerc_, percentResult);
    cb.Call({env.Null(), resultsJs});
    return env.Undefined();
}
...
Napi::Value Example::RgbMaskPercentSync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    uint_fast8_t percentResult = Engine::RgbMaskPercent(this-> pixDepth_, this->bufLen_, this->pixDiff_, this->bitsetCount_, this->bitsetVec_, buf0, buf1);
    Napi::Array resultsJs = Results::ToJs(env, this->target_, this->diffsPerc_, percentResult);
    cb.Call({env.Null(), resultsJs});
    return env.Undefined();
}
...
Napi::Value Example::RgbAllPercentAsync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    RgbAllPercent *rgbAllPercent = new RgbAllPercent(this->target_, this->pixCount_, this-> pixDepth_, this->bufLen_, this->pixDiff_, this->diffsPerc_, buf0, buf1, cb);
    rgbAllPercent->Queue();
    return env.Undefined();
}
...
Napi::Value Example::RgbMaskPercentAsync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    RgbMaskPercent *rgbMaskPercent = new RgbMaskPercent(this->target_, this-> pixDepth_, this->bufLen_, this->pixDiff_, this->diffsPerc_, this->bitsetCount_, this->bitsetVec_, buf0, buf1, cb);
...
Napi::Value Example::RgbRegionsPercentAsync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    RgbRegionsPercent *rgbRegionsPercent = new RgbRegionsPercent(this-> pixDepth_, this->bufLen_, this->minDiff_, this->regionsLen_, this->regionVec_, buf0, buf1, cb);
...
Napi::Value Example::GrayRegionsBoundsAsync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    GrayRegionsBounds *grayRegionsBounds = new GrayRegionsBounds(this->width_, this->height_, this->minDiff_, this->regionsLen_, this->regionVec_, buf0, buf1, cb);
...
Napi::Value Example::RgbRegionsBoundsSync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    ...
    Napi::Array resultsJs = Results::ToJs(env, this->regionsLen_, this->regionVec_, boundsResultVec);
    cb.Call({env.Null(), resultsJs});
    return env.Undefined();
}
...
Napi::Value Example::RgbAllBoundsAsync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    RgbAllBounds *rgbAllBounds = new RgbAllBounds(this->target_, this->width_, this->height_, this->pixCount_, this-> pixDepth_, this->pixDiff_, this->diffsPerc_, buf0, buf1, cb);
    rgbAllBounds->Queue();
    return env.Undefined();
}
...
Napi::Value Example::RgbMaskBoundsAsync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    RgbMaskBounds *rgbMaskBounds = new RgbMaskBounds(this->target_, this->width_, this->height_, this-> pixDepth_, this->pixDiff_, this->diffsPerc_, this->bitsetCount_, this->bitsetVec_, buf0, buf1, cb);
    rgbMaskBounds->Queue();
    return env.Undefined();
}
...
Napi::Value Example::RgbRegionsBoundsAsync(const uint_fast8_t *buf0, const uint_fast8_t *buf1, const Napi::Function &cb) {
    const Napi::Env env = cb.Env();
    RgbRegionsBounds *rgbRegionsBounds = new RgbRegionsBounds(this->width_, this->height_, this-> pixDepth_, this->minDiff_, this->regionsLen_, this->regionVec_, buf0, buf1, cb);
