...
if (target === 'all') {
    ...
    const region1 = {name: 'TOP_LEFT', difference: 10, percent: 7, polygon: [{x: 0, y: 0}, {x: 959, y: 0}, {x: 959, y: 539}, {x: 0, y: 539}]};
    const region2 = {name: 'BOTTOM_LEFT', difference: 10, percent: 7, polygon: [{x: 0, y: 540}, {x: 959, y: 540}, {x: 959, y: 1079}, {x: 0, y: 1079}]};
    const region3 = {name: 'TOP_RIGHT', difference: 10, percent: 7, polygon: [{x: 960, y: 0}, {x: 1919, y: 0}, {x: 1919, y: 539}, {x: 960, y: 539}]};
